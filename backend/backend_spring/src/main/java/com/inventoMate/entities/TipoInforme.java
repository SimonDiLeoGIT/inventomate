...
public enum TipoInforme {
    PROYECCION_DE_VENTAS("http://localhost:5173/company/reports/sales-forecasting", "Sales Forecasting", "Sales Analyst"),
    ...
    public static List<String> getNames() {
        return Arrays.stream(TipoInforme.values())
                     .map(TipoInforme::getName)
