...
public interface MeliClient {
	...
	@PostMapping(value = "${meli.url.refresh-token}", consumes = "application/x-www-form-urlencoded")
	JSONObject refreshToken(@RequestParam("grant_type") String grantType, @RequestParam("client_id") String clientId,
